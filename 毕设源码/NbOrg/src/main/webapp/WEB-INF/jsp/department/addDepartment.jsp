...
<div id="body" class="container">
	<div class="row">
		...
		<div class="col-md-8">
			<h1>添加部门</h1>
			<br>
			<form id="signupForm" class="form-horizontal" method="post" action="department/add">
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<div class="col-md-8">
							<select id="id_select" class="selectpicker bla bla bli"
								data-live-search="true" name="pdep">
								<optgroup label="请选择所属部门" data-subtext="只能选一个"
									data-icon="icon-ok">
				...
				<div class="row">
					<div class="col-md-12 text-center">
						...
						&nbsp;&nbsp;&nbsp;&nbsp; <a href="department/list" type="button"
...
$().ready(function() {
	 $("#signupForm").validate({
	   ...
	   name: 
		   {
		   required: "<font color=red>请输入部门名称</font>",
	    ...
	    id_select:"主管部门不能为空",
		  contactPerson:
		  {
			   required: "<font color=red>请填写部门联系人<font>",
			   nameCheck: "用户名只能包括中文字、英文字母"
			   },
		   contactNumber:
		   {
			   required: "<font color=red>请填写部门联系方式</font>",
