...
<div id="body" class="container">
	<div class="row">
		...
		<div class="col-md-8">
			<form class="form-horizontal" action="application/finishEdit"
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<div class="col-md-9">
							<div style="width: 75%">
								<textarea name="description" class="form-control" rows="3">${application.description}</textarea>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-md-9">
							<div style="width: 75%">
								<input type="text" class="form-control"
									...
									value="${application.saml.issuer }" disabled>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-md-9">
							<div style="width: 75%">
								<input type="text" class="form-control" placeholder="请输入回调URL"
									name="saml.url" value="${application.saml.url}"
						...
						<div class="col-md-9">
							<div style="width: 75%">
								<input type="text" class="form-control" placeholder="请输入登出URL"
									name="saml.logoutUrl" value="${application.saml.logoutUrl }"
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<div class="col-md-9">
							<div style="width: 75%">
								<input type="text" class="form-control" placeholder="请输入回调URL"
									name="oauth.url" value="${application.oauth.url}"
							...
							<table style="width: 100%">
								<tr>
									<td width="75%"><input type="text" class="form-control"
										...
										value="${application.oauth.oauthKey}" disabled /></td>
									<td width="10%">
							...
							<table style="width: 100%">
								<tr>
									<td width="75%"><input type="text" class="form-control"
										...
										value="${application.oauth.oauthSecret}" disabled /></td>
									<td width="10%">
						...
						<div class="col-md-9">
							<div style="width: 75%">
								<input type="text" class="form-control" placeholder="请输入url"
									name="sts.endpoint" value="${application.sts.endpoint }" />
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-md-9">
							<div style="width: 75%">
								<select id="id_select_alias" class="selectpicker bla bla bli"
									...
									autofocus="${application.sts.certAlias}">
									<optgroup label="请选择证书" data-subtext="只能选一个"
										data-icon="icon-ok">
										<c:forEach items="${alias}" var="cert" varStatus="id">
											<option
												<c:if test="${cert eq application.sts.certAlias}">selected="selected"</c:if>>${cert}</option>
										</c:forEach>
									</optgroup>
								</select>
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<a href="javascript:submit()" type="button"
							class="btn btn-success" onmouseover="javascript:mouseOver()">更新</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
							href="application/list" type="button" class="btn btn-danger">返回</a>
					</div>
